...
class Epic_Charts_Admin {
	...
	public function epic_charts_custom_metabox() {
		...
		foreach ($screens as $screen) {
			add_meta_box(
				'epic_chart_box',
				'Chart Details',
				array($this, 'epic_chart_box_html'),
				$screen,
				'normal',
				'high'
			);
    ...
    public function epic_chart_box_html() {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <table data-setid="set<?php echo $i; ?>" class="chart-data-table">
                                            ...
                                            <tbody>
                                                <?php $this->create_data_row_view($dataset, $i); ?>
                                            </tbody>
                                        </table>
                                        <div class="actions">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <table data-setid="set1" class="chart-data-table">
                                            ...
                                            <tbody>
                                                <?php $this->create_data_row_view(array(), 1); ?>
                                            </tbody>
                                        </table>
                                        <div class="actions">
                                            <button id="add-data-row" class="button button-primary">Add Row of Data</button>
    ...
    public function create_data_row_view($data, $setid) {			
        if(!empty($data)) {
            $data = $data['data'];
